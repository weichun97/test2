 ...
 */
@Data
@ApiModel(value = "${packageName}.<#if module!=null && module?length gt 0>${module?trim}.</#if>entity.vo.${tableInfo.tableNameCamelCase}VO")
public class ${tableInfo.tableNameCamelCase}VO implements Serializable{
